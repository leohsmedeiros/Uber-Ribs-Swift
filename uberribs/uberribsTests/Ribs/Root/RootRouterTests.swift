...
final class RootRouterTests: XCTestCase {
    ...
    override func setUp() {
        ...
        router = RootRouter(interactor: rootInteractor, viewController: RootViewControllableMock(),
                            loggedOutBuilder: LoggedOutBuildableMock(), loggedInBuilder: loggedInBuilder)
    }
